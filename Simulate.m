...
output_dir = "./NewSimulationData/veryGoodChannel/";
...
for v=1:numel(v_vector)
    ...
    device = DeviceOptimization("./Data/",Wmax,roll_off,betaDev,fmax,fmin,kappa,N0,pmax,mu_vector(v),ni_vector(v),lambda_vector(v),v_vector(v));
